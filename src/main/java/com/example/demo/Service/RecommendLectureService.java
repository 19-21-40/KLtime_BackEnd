...
public class RecommendLectureService {
    ...
    public void recommendLecture() {
        ...
        Set<String> reqLec = setRequiredLecture();
        ...
        student.CheckIfListenLectures(reqLec,"광운인되기", "대학영어", "C프로그래밍", "컴퓨팅사고", "공학설계입문", "C프로그래밍","고급C프로그래밍및설계");
        // 실험과목 1개라도 들었을 경우, reqLec에서 "및실험"을 포함한 과목을 remove함
        student.CheckIfListenSimilarLecture(reqLec,"및실험");

        System.out.println(reqLec);

        System.out.println(essBalMap);
